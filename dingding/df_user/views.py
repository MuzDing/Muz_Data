...
def change_password(request):
    return render(request,'df_user/changepassword.html')
...
def getcode(request):
    ...
    if mobile:
        ...
        if res:
            ...
            code = str(c)
            request.session['moblie'] = code
            yunpian_code = yunpian.YunPian(APIKEY)
            sms_status = yunpian_code.send_sms(code=code, mobile=mobile)
            msg = sms_status.msg
